-- Redefinir la función cancelar_sesion_coworking para asegurar que no contenga el filtro restrictivo de producto_id
-- y permita la reintegración de stock en componentes de paquetes coworking.
