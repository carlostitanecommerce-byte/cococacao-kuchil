            ...
            {canLeft && (
              <>
                ...
                <button
                  ...
                  className="hidden lg:flex absolute left-0 top-1/2 -translate-y-1/2 h-6 w-6 items-center justify-center rounded-full bg-background border border-border shadow-sm hover:bg-accent"
                >
